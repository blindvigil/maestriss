...
Every provider maintains its own regression suite because provider behavior is distinct. A regression discovered in one provider should not automatically become a rule for all providers.
