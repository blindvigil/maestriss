---
Document ID: REF-04
Document Title: Browser and Tab Management
Version: v0.2.0
Revision Date: 2026-07-10
Status: Authoritative Reference
Audience: AI
Purpose: AI-optimized edition of the Maestriss engineering reference for Browser and Tab Management.
...
Related Documents:
  - ../Human/04 - Browser and Tab Management.md
...
| Field | Value |
| --- | --- |
| Canonical Document ID | REF-04 |
| Canonical Title | Browser and Tab Management |
| Companion Human Edition | ../Human/04 - Browser and Tab Management.md |
