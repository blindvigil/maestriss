...
Audience: AI
Purpose: AI-optimized edition of the Maestriss engineering reference for Driver Lifecycle Specification.
...
| Field | Value |
| --- | --- |
| Canonical Document ID | REF-03 |
| Canonical Title | Driver Lifecycle Specification |
| Companion Human Edition | ../Human/03 - Driver Lifecycle Specification.md |
