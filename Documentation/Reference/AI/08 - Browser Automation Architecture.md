---
Document ID: REF-08
Document Title: Browser Automation Architecture
Version: v0.2.0
Revision Date: 2026-07-10
Status: Authoritative Reference
Audience: AI
Purpose: AI-optimized edition of the Maestriss engineering reference for Browser Automation Architecture.
...
Related Documents:
  - ../Human/08 - Browser Automation Architecture.md
...
| Field | Value |
| --- | --- |
| Canonical Document ID | REF-08 |
| Canonical Title | Browser Automation Architecture |
| Companion Human Edition | ../Human/08 - Browser Automation Architecture.md |
