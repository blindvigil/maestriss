...
**Onboarding note:** New maintainers should start with `Documentation/Reference/Human/Start_Here.md`. High-level project AI sessions should start with `Documentation/Reference/AI/Web_AI_Prompt.md`, then continue to `Documentation/Reference/AI/Web_AI_Bootstrap.md` and `Documentation/Reference/AI/Start_Here.md`. VS Code or repository-attached engineer AI sessions should start with `Documentation/Reference/AI/VSC_AI_Prompt.md`, then continue to `Documentation/Reference/AI/VSC_AI_Bootstrap.md` and `Documentation/Reference/AI/Start_Here.md`. All readers should read the most recent milestone handoff in `Documentation/Handoffs/` for current project state before using this runbook for specific procedures.
