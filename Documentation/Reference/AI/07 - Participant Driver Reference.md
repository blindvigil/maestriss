---
Document ID: REF-07
Document Title: Participant Driver Reference
Version: v0.2.0
Revision Date: 2026-07-10
Status: Authoritative Reference
Audience: AI
Purpose: AI-optimized edition of the Maestriss engineering reference for Participant Driver Reference.
...
Related Documents:
  - ../Human/07 - Participant Driver Reference.md
...
| Field | Value |
| --- | --- |
| Canonical Document ID | REF-07 |
| Canonical Title | Participant Driver Reference |
| Companion Human Edition | ../Human/07 - Participant Driver Reference.md |
